...
![Home for a project named voltaic. Its permanent Board tab organizes tasks in five columns, and the Chat control starts a Board chat.](../../../assets/screenshots/board.png)
