 ...
 *     node apps/desktop/e2e/opencode-env-smoke.mjs
 *
...
const SCREENSHOT_DIR =
  "/private/tmp/claude-501/-Users-phalasiya-Desktop-code-volli-code/a265f6c6-c44f-45fc-b5f8-45fdcec48682/scratchpad/phase3";
...
async function captureFailureEvidence(page, mainOut, mainErr, rendererConsole, label) {
  ...
  const screenshotPath = join(SCREENSHOT_DIR, `opencode-env-${slug}.png`);
  const logPath = join(SCREENSHOT_DIR, `opencode-env-${slug}.log`);
