          ...
          <Command.List className="max-h-64 overflow-y-auto p-1">
            ...
            {items.map((item) => (
              <Command.Item
                ...
                className="flex cursor-pointer items-center justify-between gap-2 rounded-sm px-2 py-1.5 text-sm outline-none data-[selected=true]:bg-accent data-[selected=true]:text-foreground"
              >
