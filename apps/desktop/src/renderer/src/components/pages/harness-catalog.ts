/**
 * The list the Harness Runtimes settings category selects from.
 *
 ...
 * harnesses, in what order, under which origin) lives on this side of the seam.
 */
import { FIRST_CLASS_HARNESS_IDS, harnessAdapters, type HarnessAdapter } from "@volli/shared";
