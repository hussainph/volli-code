      ...
      categories: [
        {
          ...
          label: "General",
          icon: GearSixIcon,
          keywords: ["window", "project switcher", "sidebar", "rail", "show", "keep open"],
          content: <GeneralPane />,
        },
        {
          key: "appearance",
        ...
        },
        {
          ...
          label: "Notifications",
          icon: BellIcon,
          keywords: ["notify", "alert", "banner", "session", "finishes", "input", "update ready"],
    ...
    },
    {
      ...
      categories: [
        ...
        },
        {
          ...
          label: "Integrations",
          icon: PlugsIcon,
          keywords: ["editor", "vscode", "cursor", "zed", "open in", "terminal", "external"],
