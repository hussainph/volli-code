...
const SURFACES: Surface[] = [
  ...
  },
  {
    ...
    sites: [
      ...
      {
        at: "sessions/new-session-menu.tsx:67",
        icon: "TerminalWindow",
        px: 16,
        ink: MUTED,
        label: "Terminal",
      ...
      {
        at: "sessions/new-session-menu.tsx:71",
        icon: "ChatCircle",
        px: 16,
        ink: MUTED,
        label: "Chat",
  ...
  },
  {
    ...
    sites: [
      ...
      {
        at: "sessions/session-tabs.tsx:469",
        icon: "ChatCircle",
        px: 12,
        ink: MUTED,
        label: "Rebase onto main",
        ...
        job: "Tab kind noun",
        verdict: "regular",
        note: "Sits immediately after a 6px solid status dot. Two solid objects in a 12px row is one too many.",
      },
      {
        at: "sessions/session-tabs.tsx:376",
        icon: "Moon",
        px: 10,
        ink: MUTED,
        label: "Parked",
        ...
        job: "Parked status",
        verdict: "regular",
        note: "The app's smallest fill. At 10px a filled moon is a blob; regular still resolves on a retina panel.",
      },
      {
      ...
      {
        at: "ticket/ticket-environment-inspector.tsx:227",
        icon: "Folders",
        px: 16,
        ink: MUTED,
        label: "Worktree",
      ...
      {
        at: "ticket/ticket-environment-inspector.tsx:204",
        icon: "ArrowClockwise",
        px: 12,
        ink: "text-destructive",
        label: "Retry",
        ...
        verdict: "regular",
        note: "1.06x — invisible change, and an affordance rather than a state despite the destructive ink.",
      },
    ],
  },
  {
